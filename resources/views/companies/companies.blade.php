                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="modal-effect btn btn-primary " data-effect="effect-scale" data-toggle="modal"
                            ...
                            <i class="fas fa-plus"></i>&nbsp; اضافة شركة</a>
                    </div>
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">إسم الشركة</th>
                                    <th class="border-bottom-0">البريد الإلكتروني</th>
                                    {{-- <th class="border-bottom-0">الشعار</th> --}}
                                    <th class="border-bottom-0">لينك موقع الشركة</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($companies as $company)
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td><img src="/Logos/{{ $company->name }}/{{ $company->logo }}" width="60"
                                                height="40"></td>
                                        <td>{{ $company->name }}</td>
                                        <td>{{ $company->email }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                data-id="{{ $company->id }}" data-company_name="{{ $company->name }}"
                                                data-company_website_url="{{ $company->website_url }}"
                                                data-email="{{ $company->email }}" data-toggle="modal"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">إضافة شركة</h6><button aria-label="Close" class="close"
                    ...
                    <form action="{{ route('companies.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="inputname">إسم الشركة</label>
                            ...
                            <div class="form-group">
                                <label for="inputname"> لينك موقع الشركة</label>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="companies/update" method="post" enctype="multipart/form-data" autocomplete="off">
                            {{ method_field('patch') }}
                            {{ csrf_field() }}
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">لينك موقع الشركة:</label>
...
@section('js')
    ...
    <script>
        $('#exampleModal2').on('show.bs.modal', function(event) {
            ...
            var website_url = button.data('company_website_url')

            var modal = $(this)
            modal.find('.modal-body #id').val(id);
            modal.find('.modal-body #name').val(company_name);
            modal.find('.modal-body #email').val(email);
            modal.find('.modal-body #website_url').val(website_url);
        })
    </script>

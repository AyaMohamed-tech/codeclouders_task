...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">برنامج إدارة الشركات</li>
            <li class="slide">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'companies')) }}">الشركات</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'employees')) }}">العملاء</a></li>
                </ul>
            </li>
